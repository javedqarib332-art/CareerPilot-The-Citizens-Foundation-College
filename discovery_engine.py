...
PDTI_QUESTIONS = {
    "People": [
        {"en": "Helping a classmate understand something until they finally get it."},
        {"en": "Leading a group project and making sure everyone gets a chance to speak."},
        {"en": "Sitting with an upset friend and just listening, without rushing to fix things."},
        {"en": "Introducing yourself to strangers and starting a conversation with them."},
        {"en": "Convincing a group to try your idea, even if they weren't sure at first."},
        {"en": "Organizing an event that brings a lot of different people together."},
        {"en": "Noticing when someone near you is having a hard day, even if they haven't said so."},
        {"en": "Being the person others come to first when they need help or advice."},
    ],
    "Data": [
        {"en": "Looking through numbers to find a pattern nobody else noticed."},
        {"en": "Keeping careful track of how much money you spend and save."},
        {"en": "Doing a small experiment step by step to check if your guess was right."},
        {"en": "Checking a report carefully for mistakes before anyone else sees it."},
        {"en": "Finding the cheapest, smartest way to plan a trip or a budget."},
        {"en": "Writing step-by-step instructions or code for a computer to follow exactly."},
        {"en": "Comparing a few options carefully before deciding which one is best."},
        {"en": "Turning messy information into neat categories or a table."},
    ],
    "Things": [
        {"en": "Taking apart a broken gadget or toy to see what went wrong inside."},
        {"en": "Building or putting something together with your hands until it's done right."},
        {"en": "Following a recipe or steps exactly to cook or make something."},
        {"en": "Fixing something that broke — like a bike chain, a leaking tap, or a loose hinge."},
        {"en": "Spending an afternoon actually building something rather than just reading about it."},
        {"en": "Learning how a machine or engine works by looking at it closely yourself."},
        {"en": "Working outside doing physical tasks instead of sitting at a desk."},
        {"en": "Using tools carefully to get a hands-on task exactly right."},
    ],
    "Ideas": [
        {"en": "Coming up with a totally new way to solve a problem everyone else solves the same old way."},
        {"en": "Writing a story, poem, or song just because the idea wouldn't leave your head."},
        {"en": "Wondering 'why does this work this way?' until you actually find out the answer."},
        {"en": "Sketching, designing, or imagining something that doesn't exist yet."},
        {"en": "Talking through a big 'what if' question just for the fun of thinking about it."},
        {"en": "Seeing a completely new way to look at a problem you already know well."},
        {"en": "Getting so into art, design, or a performance that you lose track of time."},
        {"en": "Preferring open tasks where you get to decide how to do them yourself."},
    ],
}
...
BIG_FIVE_QUESTIONS = {
    "Openness": [
        ...
        {"text": "I enjoy thinking about big ideas that aren't about everyday things.", "text_ur": "مجھے تجریدی یا نظریاتی خیالات پر سوچنا اچھا لگتا ہے۔", "reverse": False},
        {"text": "I'm not very interested in ideas that aren't about everyday things.", "text_ur": "مجھے تجریدی خیالات میں زیادہ دلچسپی نہیں۔", "reverse": True},
        {"text": "I prefer doing things the way I already know, rather than trying something new.", "text_ur": "میں نئے تجربات کی بجائے جانی پہچانی روٹین کو ترجیح دیتا/دیتی ہوں۔", "reverse": True},
    ],
    "Conscientiousness": [
        {"text": "I always get ready before I actually need to.", "text_ur": "میں ضرورت سے پہلے ہی تیار رہتا/رہتی ہوں۔", "reverse": False},
        {"text": "I pay close attention to small details in my work.", "text_ur": "میں اپنے کام کی باریکیوں پر خاص توجہ دیتا/دیتی ہوں۔", "reverse": False},
        {"text": "I often leave things until the last minute.", "text_ur": "میں اکثر کام آخری وقت کے لیے چھوڑ دیتا/دیتی ہوں۔", "reverse": True},
        {"text": "It's hard for me to finish something once it starts to feel boring.", "text_ur": "جب کوئی کام بورنگ ہو جائے تو اسے مکمل کرنا میرے لیے مشکل ہوتا ہے۔", "reverse": True},
    ],
    "Extraversion": [
        {"text": "I feel relaxed around people I don't know well.", "text_ur": "میں ان لوگوں کے ساتھ بھی سہولت محسوس کرتا/کرتی ہوں جنہیں اچھی طرح نہیں جانتا/جانتی۔", "reverse": False},
        {"text": "I start conversations instead of waiting for others to start them.", "text_ur": "میں دوسروں کا انتظار کرنے کے بجائے خود بات چیت شروع کرتا/کرتی ہوں۔", "reverse": False},
        {"text": "In a group, I prefer to stay quiet in the background.", "text_ur": "گروپ میں مَیں پیچھے رہنا پسند کرتا/کرتی ہوں۔", "reverse": True},
        {"text": "Being around large groups for a long time tires me out.", "text_ur": "بڑے گروہوں میں زیادہ دیر رہنا مجھے تھکا دیتا ہے۔", "reverse": True},
    ],
    "Agreeableness": [
        {"text": "I understand how others are feeling pretty easily.", "text_ur": "میں دوسروں کے جذبات کو آسانی سے سمجھ لیتا/لیتی ہوں۔", "reverse": False},
        {"text": "I make time for others even when it's not convenient for me.", "text_ur": "میں مشکل وقت میں بھی دوسروں کے لیے وقت نکالتا/نکالتی ہوں۔", "reverse": False},
        {"text": "I am not very interested in other people's problems.", "text_ur": "مجھے دوسروں کے مسائل میں زیادہ دلچسپی نہیں۔", "reverse": True},
        {"text": "It's hard for me to meet someone halfway when we disagree.", "text_ur": "جب کسی سے اختلاف ہو تو سمجھوتہ کرنا میرے لیے مشکل ہوتا ہے۔", "reverse": True},
    ],
    "EmotionalStability": [
        {"text": "I stay calm when I'm under pressure or facing a deadline.", "text_ur": "دباؤ یا ڈیڈ لائن میں بھی میں پرسکون رہتا/رہتی ہوں۔", "reverse": False},
        {"text": "When something goes wrong, it doesn't affect my mood for long.", "text_ur": "ناکامیاں میرے موڈ کو زیادہ دیر متاثر نہیں کرتیں۔", "reverse": False},
